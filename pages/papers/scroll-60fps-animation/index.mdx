...
4. There's one **drawback**! You're gonna be downloading hundreds of images. Consider a good compression and even checking the network first to see if it's worth downloading for your user. To be fair, this technique is similar to a video but lighter. So, it's not that bad.
