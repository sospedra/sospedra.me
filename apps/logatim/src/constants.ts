// ANSI: restore the default background, then reset all attributes
export const EOL = '\u001b[49m\u001b[0m'

export const STORAGE_KEY = 'logatimLevel'
...
export const DEFAULT_LEVEL: number = LEVELS.WARN

export const LOG_METHOD_NAMES = [
  'trace',
  'debug',
  'info',
  'warn',
...
export type LogMethodName = (typeof LOG_METHOD_NAMES)[number]
