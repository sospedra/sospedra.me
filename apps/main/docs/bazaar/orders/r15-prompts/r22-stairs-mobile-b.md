# Codex order — r22b — SM probe B: open drum, no cage
...
/Users/sospedra/labs/sospedra.me/tmp/bazaar3/master-run-20260728/r22/gen-stairs-mobile-b.png
...
1. CAGE SHAFT, x=320..720 full height: the drum's riveted steel
   ...
   #282825 rim every 96 px down each post; a fully OPEN front — no
   cage bars anywhere; near-black recess #020406 with a #0b1216
...
4. UPPER EXIT: at x=620..720, y=608..768 a doorway frame stands at
   the shaft face — clean squared jambs in post steel (#453d34 / #584a3c / #020406
...
7. THRESHOLD LIGHT STRIPS: one inset amber strip per exit, the
   ...
   #584a3c step. Upper strip on the deck's front face x=744..808,
   y=776..792. Lower strip inside the lower aperture at ground,
   x=640..704, y=1500..1516.
8. COLUMN CONTINUITY: above and below both apertures the posts and
   bolt rows run unbroken; the helix stays fully visible.
...
5) Count treads: ~fifteen per story, 50 px risers, one continuous
   helix, fully visible top to bottom — zero cage bars anywhere.
