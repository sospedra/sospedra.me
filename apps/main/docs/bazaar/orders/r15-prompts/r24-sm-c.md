# Codex order — r24c — SM probe C: maximum chunk
...
/Users/sospedra/labs/sospedra.me/tmp/bazaar3/master-run-20260728/r24/gen-sm-c.png
...
2. THE INTERIOR — like Image 1, never pitch black: base #020406 with
   ...
   spiral and subtle vertical panel seams #0b1216 every ~96 px.
   Sample Image 1's recess; reproduce that depth.
3. CENTER POLE, x=496..544, full height: #16191a body, #282825 light
   line, coupling rings every 192 px.
4. SPIRAL TREADS — Image 3's construction, exactly: each tread an
...
- Minimum color cluster 4x4 px. No single-pixel dithering, no 1 px
  noise, no per-tread tonal variation.
- Outlines 4 px, near-black, continuous.
...
#37322b #6a523b #382514 — 9 values, the complete palette (the pole
mid-tone is gone: poles are two-tone).
