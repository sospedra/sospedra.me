...
export const metadata: Metadata = {
  title: 'Manifesto — The Olympics Score',
  description: 'How the ranking of The Olympics Score works?',
}

export default function Manifesto() {
  return (
    <div>
      <main className='container mx-auto flex max-w-lg flex-col justify-center px-2'>
        <h4 id='understand' className='pt-6 pb-2 font-bold text-lg'>
        ...
        <h4 id='why' className='pt-6 pb-2 font-bold text-lg'>
          Why?
        </h4>
        ...
        <h4 className='pt-6 pb-2 font-bold text-lg'>How?</h4>
        <p className='pb-4'>
