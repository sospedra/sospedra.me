# Codex order - r20.11 - portrait console, family width (10pct over videoclub)
...
Flat chroma green #00ff00 outside the art. Art EXACTLY 608 px
wide (x=208..816), 800 tall (y=568..1368). Each side keeps a
chroma margin of about 208 px. Ground line y=1368.

## THE ANGLE - unchanged law

- Slab top face: back edge x=276..748 at y=1223, front edge
  x=208..816 at y=1304. Sides EXACTLY 68 px inward per 81 down.
- Checkpoints the edges pass through:
  left: (276,1223) (259,1243) (242,1263) (225,1283) (208,1304)
  right: (748,1223) (765,1243) (782,1263) (799,1283) (816,1304)
- Front face: x=208..816, y=1304..1368, corners 90 degrees.
- Steeper or flatter = REJECTION.

## THE ONE CHANGE - the sign system

The master's hanging sign and bent pole are RETIRED. New system:
- A scavenged street LAMP POST, x=786..806, y=600..930: ONE straight
  DEAD-VERTICAL dark steel post, base disappearing behind the
  shelving; a small DEAD square lamp head on top, x=772..812, y=568..600,
  unlit glass.
- THE SIGN PLATE x=536..800, y=590..687: the same rusted riveted plate
...
INWARD only):
- SERVER RACK A x=252..414, y=860..1260, dead vertical, LED dot rows,
  one band ajar. ON TOP the ONLY LIT SCREEN: CRT x=268..408, y=772..860,
...
- OPEN SHELVING x=614..774, y=928..1264, dead vertical: dead amp, three
  tape decks, coiled cables.
- PERIPHERALS BOX x=624..752, y=1196..1296: open cardboard, two beige
  keyboards leaning out, mouse hanging by its cable.
- PIZZA BOX x=292..388, y=1264..1300, lid flat left, two slices.
- POWER STRIP x=404..500, y=1280..1298: four plugs, one lit switch.
- HANDHELD PILE x=504..584, y=1268..1300: dead handhelds.
- RUG x=234..790, y=1252..1300: fills the slab face, concentric trapezoid,
...
Landscape composition, art wider than 620 px, tilted or
...
unmodified to /Users/sospedra/labs/sospedra.me/tmp/bazaar3/master-run-20260728/r20-console/gen11-a.png and print GENERATED=<path>.
