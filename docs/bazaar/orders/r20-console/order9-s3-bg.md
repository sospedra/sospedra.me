# Codex order - r20.9-s3 background group, lean order
...
unmodified to /Users/sospedra/labs/sospedra.me/tmp/bazaar3/master-run-20260728/r20-console/gen9-s3-bg.png and print GENERATED=<path>.
