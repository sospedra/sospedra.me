# Codex order - r20.9-s3 floor group, lean order
...
- Image 2 = ED, the character gospel (a film still). Copy the KID:
...
unmodified to /Users/sospedra/labs/sospedra.me/tmp/bazaar3/master-run-20260728/r20-console/gen9-s3-floor.png and print GENERATED=<path>.
