# Codex order - r20.8c - console master, nest edition (verdict instrument)
...
- Image 2 = the ANGLE VERDICT: the LEFT construction (50 degrees,
  ...
  construction (62 degrees, crossed out red) is the previous
  attempt and a REJECTION. Draw the left one. Its flat green and
  magenta are LABELS, never art colors: the real slab is WOOD.
...
unmodified to r20-console/gen8c.png and print GENERATED=<path>.
