# Codex order — r23b — SM probe B: railed halfway deck
...
/Users/sospedra/labs/sospedra.me/tmp/bazaar3/master-run-20260728/r23/gen-sm-b.png
...
- UPPER PLATFORM: x=720..857, top walking surface ON y=768 (the
  ...
  squared edge. Two support brackets beneath, anchored to the shaft
...
5. UPPER PLATFORM, x=720..857, y=768..840: two flat stacked bands
   ...
   exactly ON y=768. The helix meets it openly at that height. At
   the deck's outer end a 40 px guard rail: two 3 px balusters
   #16191a carrying a warm-brown top rail #584a3c with #37322b
   shadow — the same rail grammar as the helix.
...
7. THRESHOLD LIGHT STRIPS: one inset amber strip per platform, the
   ...
   y=776..792. Lower strip on the pad's front face x=736..800,
   y=1504..1520.
